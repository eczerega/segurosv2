class UsuariosController < ApplicationController
  ...
  private
    ...
    def usuario_params
      params.require(:usuario).permit(:nombre, :apellido, :rut, :dv, :email, :telefono_fijo, :telefono_celular, :password, :password_confirmation, :image, :tipo, :estado, :punto_venta)
    end
end
